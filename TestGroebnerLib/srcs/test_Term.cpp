...
void test_term() {
    ...
    assert_term_(term3 * term4, {0, 0, 17, 1, 2});

    std::cout << "t3 =\t\t" << term3 << '\n';
    std::cout << "t3 *= t4 =\t" << (term3 *= term4) << '\n';
    std::cout << "t3 =\t\t" << term3 << '\n';
    assert_term_(term3, {0, 0, 17, 1, 2});

    std::cout << "t3 /= t4 = \t" << (term3 /= term4) << '\n';
    std::cout << "t3 =\t\t" << term3 << '\n';
    assert_term_(term3, {0, 0, 5, 0, 2});
    ...
    assert_term_(term8 / term7, {0, 1});

    std::cout << "t7 * t8 / t8 = " << term7 * term8 / term8 << '\n';
    assert_term_(term7 * term8 / term8, {1, 2, 5});
